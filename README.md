# Hikma: organisation configuration

This repository holds the shared GitHub configuration for the Hikma organisation. It carries no project content: no pipeline code, no specification, no dataset. Every other repository in the organisation inherits the issue and pull request templates and community health files kept here, so a change to one of those takes effect across all of them at once.
